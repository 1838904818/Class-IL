...
class Binding(unittest.TestCase):
    def test_exact_executable_closure(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            plan={'schema':'replayids-fidelity-profile-v2','walltime_seconds':600,'verifier_deadline_seconds':480,
                'allocated_memory_mib':4096,'wandb_version':'0.23.0','wandb':{'entity':'csnet','project':'ofra-etg-leon-hpc',
                    'group':'replayids-score-fidelity-profile-v2'},'executables':{n:m.digest(root/n) for n in names}}
...
class CoordinatorFlow(unittest.TestCase):
    ...
    def exercise(self,init_fails=False,finish_fails=False):
        with tempfile.TemporaryDirectory() as d:
            ...
            plan={'schema':'replayids-fidelity-profile-v2','walltime_seconds':600,'verifier_deadline_seconds':480,
                'allocated_memory_mib':4096,'wandb_version':'0.23.0','wandb':{'entity':'csnet','project':'ofra-etg-leon-hpc',
                    'group':'replayids-score-fidelity-profile-v2'},'executables':{n:'a'*64 for n in names},
            ...
            with patch.dict('sys.modules',{'wandb':sdk,'pwd':pwd,'check_replayids_gpu_fidelity':core}),\
                 ...
                 patch.object(m,'process_sample',return_value=(0.,0)),patch.object(m.signal,'signal'),\
...
class TrackingPrivacy(unittest.TestCase):
    def test_history_rejects_private_fields_and_text(self):
        ...
        for value in ('/home/private','leon12138','SLURM_JOB_ID=123',float('nan'),-1):
    ...
    def test_identity_is_hash_only_and_config_exact(self):
        ...
        for value in ('job-123','/home/private','leon12138','a'*64+'extra'):
