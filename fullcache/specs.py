...
DATASET_SPECS: dict[str, DatasetSpec] = {
    ...
    "malaya-network-gt": DatasetSpec(
        ...
        # Point --data-root at work/malaya_network_gt_20260716.  This keeps the
        # pinned clone in place and avoids copying any of its 31 captures.
        subdirectory="repo/csv_output",
        label_candidates=(),
