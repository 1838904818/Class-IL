...
def _optimizer_schedule(
    ...
    return {
        "gradient_microbatches_per_epoch": steps,
...
def _build_report(
    *,
    ...
    gradient_accumulation_steps = int(
        config_record["gradient_accumulation_steps"]
    )
            ...
            families.append(
                {
                    ...
                    "positive_rows_per_optimizer_step": (
                        positive_batch_rows * gradient_accumulation_steps
                    ),
    ...
    semantic: dict[str, object] = {
        ...
        "derivation": {
            ...
            "optimizer_step_formula": (
                "ceil(gradient_microbatches/gradient_accumulation_steps)"
            ),
            "zero_negative_steps": (
